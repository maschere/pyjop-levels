...
editor.specify_goal("fib_goal", "Calculate the Fibonacci number at index 100 and enter the result in the DataExchange under key 'result'.", fib_goal)
...
def on_reset():
    ...
    DataExchange.first().remove_data("result")
